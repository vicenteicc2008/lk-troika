...
#define CFG_FASTBOOT_TRANSFER_BUFFER_SIZE	(0x2F000000)
...
int fboot_usb_int_bulkin(u64 buffer, u64 buffer_size)
{
	...
	g_pBulkInTrb = (usbdev3_trb_ptr_t)exynos_usb_malloc(g_uCntOfBulkInTrb * sizeof(usbdev3_trb_t),
	                                                    USBDEV3_MDWIDTH / 8);
	...
	if (!exynos_usb_start_ep_xfer(USBDEV3_EP_DIR_IN, BULK_IN_EP, (u64)g_pBulkInTrb, 0,
