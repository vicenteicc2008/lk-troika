...
#define EXYNOS3830_KEYSTORAGE_NWD_ADDR		(0x89000000)
#define EXYNOS3830_KEYSTORAGE_PARTITION_SIZE	(16 * 512)
#define EXYNOS_AP_MAGIC				(0x49534c53)

#define EXYNOS3830_LDFW_NWD_ADDR		(0x88000000)
#define EXYNOS3830_LDFW_PARTITION_SIZE		(8192 * 512)
#define EXYNOS_LDFW_MAGIC			(0x10adab1e)

#define EXYNOS3830_SSP_NWD_ADDR			(EXYNOS3830_LDFW_NWD_ADDR)
#define EXYNOS3830_SSP_PARTITION_SIZE		(1024 * 512)

#define EXYNOS3830_SP_NWD_ADDR			(EXYNOS3830_LDFW_NWD_ADDR)
#define EXYNOS3830_SP_PARTITION_SIZE		(1024 * 1024)           /* 1 MB */
