/*
 * acpm.h - common header for framework and plugins
 *
...
#define get_acpm_plugin_element(__struct, __element)					\
	EXYNOS3830_ACPM_BASE + __struct##_address +					\
			((unsigned int *)&(((struct __struct *)0)->__element) -		\
			 (unsigned int *)((struct __struct *)0)) * 4
