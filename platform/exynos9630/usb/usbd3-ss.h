...
typedef union
{
	u32 data;	// reset value : 0x00000000
	struct {
		// bit[5:0] : event buffer size in bytes (must be a multiple of 4)
		unsigned gfladj_30mhz:6;
		// bit[6] :
		unsigned reserved_6:1;
		// bit[7] : event interrupt mask (1 : prevent the interrupt from being generated)
		unsigned gfladj_30mhz_sdband_sel:1;
		// bit[21:8] :
		unsigned gfladj_refclk_fladj:14;
		// bit[22] :
		unsigned reserved_22:1;
		// bit[23] :
		unsigned gfladj_refclk_lpm_sel:1;
		// bit[30:24] :
		unsigned gfladj_refclk_240mhz_decr:7;
		// bit[31] :
		unsigned gfldj_refclk_240mhzdecr_pls1:1;
	}b;
} usbdev3_gfladj_t;
...
inline phys_addr_t virt_to_phys(void * vaddr)
{
