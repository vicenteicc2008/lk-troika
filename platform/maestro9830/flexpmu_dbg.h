...
#define EXYNOS9830_DUMP_FLEXPMU_OFFSET		(0x10000)
#define EXYNOS9830_DUMP_FULLSWPMU_OFFSET	(0x16000)
#define EXYNOS9830_DUMP_FLEXPMU_BASE		(EXYNOS9830_DUMP_ACPM_BASE + EXYNOS9830_DUMP_FLEXPMU_OFFSET)
#define EXYNOS9830_DUMP_FULLSWPMU_BASE		(EXYNOS9830_DUMP_ACPM_BASE + EXYNOS9830_DUMP_FULLSWPMU_OFFSET)

#define EXYNOS9830_FLEXPMU_DBG_BASE		(EXYNOS9830_DUMP_FLEXPMU_BASE + 0x5c00)
#define EXYNOS9830_PMUDBG_BASE			(EXYNOS9830_DUMP_FULLSWPMU_BASE + 0xbe80)

#define EXYNOS9830_DUMP_GPR_OFFSET		(0xaf00)
