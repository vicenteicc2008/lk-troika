...
#include <dpu/dsim.h>
#include "s6e3fa9ub_param.h"


#define S6E3FA9UB_CMD_VBP		15
#define S6E3FA9UB_CMD_VFP		3
#define S6E3FA9UB_CMD_VSA		1
#define S6E3FA9UB_CMD_HBP		2
#define S6E3FA9UB_CMD_HFP		2
#define S6E3FA9UB_CMD_HSA		2

#define S6E3FA9UB_HORIZONTAL	1080
#define S6E3FA9UB_VERTICAL	2400

#define CONFIG_DECON_LCD_CMD_MODE

struct exynos_panel_info s6e3fa9ub_lcd_info = {
	.mode = DECON_MIPI_COMMAND_MODE,
	.vfp = S6E3FA9UB_CMD_VFP,
	.vbp = S6E3FA9UB_CMD_VBP,
	.hfp = S6E3FA9UB_CMD_HFP,
	.hbp = S6E3FA9UB_CMD_HBP,
	.vsa = S6E3FA9UB_CMD_VSA,
	.hsa = S6E3FA9UB_CMD_HSA,
	.xres = S6E3FA9UB_HORIZONTAL,
	.yres = S6E3FA9UB_VERTICAL,
...
void s6e3fa9ub_lcd_init(unsigned int id, struct exynos_panel_info *lcd)
{
	...
	if (dsim_wr_data(id, MIPI_DSI_DCS_LONG_WRITE, (unsigned long)SEQ_FFC_SET,
				ARRAY_SIZE(SEQ_FFC_SET)) < 0)
		dsim_err("fail to write SEQ_FFC_SET command.\n");
...
void s6e3fa9ub_lcd_disable(int id)
{
